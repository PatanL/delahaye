var _____WB$wombat$assign$function_____ = function(name) {
    ...
    */
        ...
        (function(ca) {
            ...
            function V(b, c, d, g) {
                c && B(c, function(c, h) {
                    if (d || !s(b, h))
                        g && "object" === typeof c && c && !H(c) && !G(c) && !(c instanceof RegExp) ? (b[h] || (b[h] = {}),
                        V(b[h], c, d, g)) : b[h] = c
                });
                return b
            }
            ...
            function ha(b) {
                ...
                function F(a, e, b) {
                    var f = a.map.id;
                    a.error ? a.emit("error", a.error) : (e[f] = !0,
                ...
                define = function(b, c, d) {
                    ...
                    if (O) {
                        if (!(g = M))
                            ...
                            g = P;
                        g && (b || (b = g.getAttribute("data-requiremodule")),
    ...
    /*
         FILE ARCHIVED ON 22:58:47 Jan 12, 2016 AND RETRIEVED FROM THE
         INTERNET ARCHIVE ON 21:08:57 Dec 03, 2024.
    ...
    */
    ...
    playback timings (ms):
      ...
      esindex: 0.017
      cdx.remote: 8.264
      LoadShardBlock: 436.523 (3)
      PetaboxLoader3.datanode: 397.476 (4)
      PetaboxLoader3.resolve: 178.174 (2)
      load_resource: 188.394
    */
